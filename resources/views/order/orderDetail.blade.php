		 ...
		 <div class="col-md-10">
		  <div class="box">
		 	<div class="box-header">
		  	...
		  	<div class="box-body">
		          <div>Order Placed at: <strong>{{$order->created_at}}</strong></div>
	              <div>Order No: <strong>{{$order->order_id}}</strong></div>
	              ...
	              <div>Total Price: <strong>{{$order->estimated_rate}}</strong></div>    
	        </div>
		  </div><!--box close-->
		  </div>
